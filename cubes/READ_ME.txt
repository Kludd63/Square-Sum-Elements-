...
If the entry starts with T, then the scale the sequence appropriately and shift by the value given after the T before placing it next in the sequence
If the entry starts with RT, then the scale the sequence appropriately, shift by the value given after the T, and then reverse it before placing it next in the sequence
